...
/**
 * SatisfactionUtility is a Spring Component Managed Bean and implements KnapSack
...
public class SatisfactionUtility {
	...
	// Gordan's best satisfaction/performance updated to perform better
	//Minkashi
	public Integer perform(Integer timeLimit, Integer eatingTimes[], Integer degreeOfSatisfactions[],
		...
		Integer i, w;
		Integer satisfactionMatrix[][] = new Integer[menuItemCount][timeLimit];
